            ...
            M.prototype.pullData = function(e, i) {
                ...
                if (a.startTime = (new Date).getTime(), n.url) {
                    ...
                    t.ajax({
                        ...
                        headers: n.headers || {},
                        success: function(t) {
                    t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t.data, e, t.data[r.countName]), d(), n.time = (new Date).getTime() - a.startTime + " ms"),
                    i && l.close(i),
